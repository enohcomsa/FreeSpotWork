...
// @ts-ignore
import { BuildingCardDTO } from '../model/building-card';
...
export interface BuildingsCardsIdGetRequestParams {
    id: string;
}
...
export class BuildingsCardsHttpService extends BaseService {
