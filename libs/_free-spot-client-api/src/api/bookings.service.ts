...
// @ts-ignore
import { BookingRescheduleDTO } from '../model/booking-reschedule';
// @ts-ignore
...
export interface BookingsAdminUserIdGetRequestParams {
    userId: string;
}

export interface BookingsIdAdminPatchRequestParams {
    id: string;
...
export interface BookingsIdPatchRequestParams {
    id: string;
    bookingRescheduleDTO?: BookingRescheduleDTO;
}
...
export class BookingsHttpService extends BaseService {
    ...
    public bookingsIdPatch(requestParameters: BookingsIdPatchRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        const bookingRescheduleDTO = requestParameters?.bookingRescheduleDTO;
