...
// @ts-ignore
import { TimetableActivityCardDTO } from '../model/timetable-activity-card';
...
export interface GetTimetableActivityCardsByRoomIdRequestParams {
    id: string;
}

export interface TimetableActivityCardsIdGetRequestParams {
    id: string;
}
...
export class TimetableActivityCardsHttpService extends BaseService {
