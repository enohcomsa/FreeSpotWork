...
r.patch("/:id", requireRole("ADMIN"), validate({ params: BookingIdParam, body: BookingUpdate }), ctrl.update);
r.delete("/:id", requireRole("ADMIN"), validate({ params: BookingIdParam }), ctrl.destroy);
