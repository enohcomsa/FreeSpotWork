...
export function registerSubjects(registry: OpenAPIRegistry) {
  ...
  registry.registerPath({
    ...
    responses: {
      200: {
        description: "OK",
        content: {
          "application/json": { schema: SubjectResponse },
        },
      },
  ...
  registry.registerPath({
    ...
    request: {
      body: {
        content: {
          "application/json": { schema: SubjectCreate },
        },
      },
    },
    responses: {
  ...
  registry.registerPath({
    method: "patch",
    path: "/subjects/{id}",
    operationId: "subjectsIdPatch",
    tags: ["Subjects"],
    request: {
      params: SubjectIdParam,
      body: {
        content: {
          "application/merge-patch+json": { schema: SubjectUpdate },
        },
      },
    },
    responses: {
