...
export const getById = withParams<FloorIdParam, FloorResponseDto>()(async (req, res) => {
...
export const update = withParamsAndBody<FloorIdParam, FloorUpdateRequest, FloorResponseDto>()(
  async (req, res) => {
...
export const destroy = withParams<FloorIdParam, void>()(async (req, res) => {
